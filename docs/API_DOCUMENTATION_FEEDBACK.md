...
Este feedback se ha generado durante el desarrollo del cliente API open-source:
https://github.com/nexusland/cuentica-api-client

Estamos disponibles para colaborar en la mejora de la documentación o proporcionar más detalles sobre cualquier punto mencionado.
